...
class OperationalSettingController(
    ...
    @PutMapping("/{operationalSettingId}")
    fun updateOperationalSetting(
        @PathVariable operationalSettingId: UUID,
        @RequestBody request: UpdateOperationalSettingRequest,
    ): OperationalSettingDto = mapper.toDto(commandBus(mapper.toCommand(request, operationalSettingId)))
